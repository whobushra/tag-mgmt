...
import { ChevronRight, ChevronLeft, Upload, Plus, Minus, ChevronDown, ChevronUp, Check } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
                ...
                {uploadedFile ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      />
                      <Button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full text-base font-medium">
